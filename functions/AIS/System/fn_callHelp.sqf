...
if ((_unit getVariable ["callHelpDelay", 0]) > diag_tickTime) exitWith {["You already have called for help!"] call AIS_fnc_dynamicText; false};
_unit setVariable ["callHelpDelay", diag_tickTime + 9];

[""] call AIS_fnc_dynamicText;
[_unit] call AIS_fnc_helpScream;

if (rating _unit < -1999) exitWith {false};

[_unit, objNull] call AIS_fnc_findAIHelper;
true