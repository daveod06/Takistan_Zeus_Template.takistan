...
[[_injured, _vehicle, 1], {_this call AIS_fnc_moveCargoRemote}] remoteExec ["call"];

// unconscious animation in cargo seat
[{[(_this select 0), 'unconscious'] remoteExec ["playActionNow", 0, false]}, [_injured]] call AIS_fnc_onNextFrame;
