...
[[_injured, _vehicle, 0], {_this call AIS_fnc_moveCargoRemote}] remoteExec ["call"];

if (_injured call AIS_fnc_allowDrag) then {
	[{[(_this select 0), (_this select 1)] call AIS_fnc_drag}, [_unit,_injured]] call AIS_fnc_onNextFrame;
};
