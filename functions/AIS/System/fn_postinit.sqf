...
[
	...
	player,
	1.5,
	"cursorTarget isKindOf 'CAManBase' && {cursorTarget getVariable ['ais_unconscious',false]} && {cursorTarget call AIS_fnc_allowRevive}",
	{
		[player, cursorTarget] spawn AIS_fnc_Revive;
	},
	[],
...
[
	...
	player,
	1.5,
	"cursorTarget isKindOf 'CAManBase' && {cursorTarget getVariable ['ais_unconscious',false]} && {cursorTarget call AIS_fnc_allowStabilize}",
	{
		[player, cursorTarget] spawn AIS_fnc_Stabilize;
	},
	[],
...
[
	...
	player,
	1.8,
	"cursorTarget isKindOf 'CAManBase' && {cursorTarget getVariable ['ais_unconscious',false]} && {cursorTarget call AIS_fnc_allowDrag}",
	{
		[player, cursorTarget] call AIS_fnc_drag;
	},
	[],
...
[
	...
	player,
	4,
	"(cursorTarget isKindOf 'LandVehicle' || cursorTarget isKindOf 'Air') && {alive cursorTarget} && {cursorTarget call AIS_fnc_allowPullOut}",
	{
		[player, cursorTarget] call AIS_fnc_unloadInjured;
	},
	[],
...
[
	...
	player,
	4,
	"!(isNull (player getVariable ['ais_DragDrop_Torso', objNull])) && {cursorTarget isKindOf 'LandVehicle' || cursorTarget isKindOf 'Air'} && {cursorTarget call AIS_fnc_allowPullIn}",
	{
		[player, cursorTarget] call AIS_fnc_loadInjured;
	},
	[],
